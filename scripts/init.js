(() => {
  const adventureName = 'The Pirates of Prexiar';
  const moduleName = 'swd6-piratesofprexiar';
   ...
   *   const creaturePacks = [];
   */
  const creaturePacks = ["swd6-piratesofprexiar.actors"];
  /**
   ...
   *   const journalPacks = [];
   */
  const journalPacks = ["swd6-piratesofprexiar.journals"];
  /**
   ...
   *   const macroPacks = [];
   */
  const macroPacks = ["swd6-piratesofprexiar.macros"];
  /**
   ...
   *   const playlistPacks = [];
   */
  const playlistPacks = ["swd6-piratesofprexiar.playlists"];
  /**
   ...
   */
  const additionalModulePacks = ["swd6-piratesofprexiar"];
